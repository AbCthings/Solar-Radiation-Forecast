...
int main(void) {
	...
	sprintf(dataMessage, "I retrieved the following data from the configuration file: %d %s %s %s %s %s %s",loopSleepSeconds,latitude,longitude,timestep,horizon,address,port);
	NewLog(fpLog, LOG_SEVERITY_INFO, dataMessage, verbose);
